...
'Helvetica Neue', sans-serif;
  ...
  <title>Mockly PUCMM - Nuevo Usuario</title>
</head>
          ...
          <div class="sm:rounded-lg">
            <div class="px-4 py-5 sm:p-6">
              <div class="mt-4 text-sm text-gray-500">
                ...
                <#if datos??>
                  <form action="/admin/usuario?id=${datos.getId()}" method="POST">
                    <#-- Linea para controlar el ataque csrf-->
                      ...
                      <div class="relative mt-2 rounded-md">
                        ...
                        <input type="text" name="nombre" id="nombre"
                          ...
                          placeholder="Nombre" value="${datos.getNombre()}" required />
                      </div>
                      ...
                      <div class="relative mt-4 md:mt-8 rounded-md">
                        ...
                        <input type="texto" name="apellido" id="apellido"
                          class="block w-full p-2 text-gray-900 border-0 rounded-md shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-emerald-600 sm:text-sm sm:leading-6"
                          placeholder="Apellido" value="${datos.getApellido()}" required />
                      </div>
                      ...
                      <div class="relative mt-4 md:mt-8 rounded-md">
                        ...
                        <input type="texto" name="username" id="username"
                          class="block w-full p-2 text-gray-900 border-0 rounded-md shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-emerald-600 sm:text-sm sm:leading-6"
                          placeholder="Nombre de usuario" value="${datos.getUsername()}" required />
                      </div>
                      ...
                      <div class="relative mt-4 md:mt-8 rounded-md">
                        ...
                        <input type="password" name="password" id="password"
                          class="block w-full p-2 text-gray-900 border-0 rounded-md shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-emerald-600 sm:text-sm sm:leading-6"
                          placeholder="Clave" value="${datos.getPassword()}" required />
                      </div>
                  ...
                  <#else>
                    <form role="form" action="/admin/usuario" method="POST">
                      <#-- Linea para controlar el ataque csrf-->
                        <#if _csrf??> <#--validando que no sea nula, si lo es, está deshabilitado el csrf -->
                            <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
                        </#if>
                        ...
                        <div class="relative mt-4 md:mt-8 rounded-md">
                          ...
                          <input type="texto" name="password" id="password"
                            class="block w-full p-2 text-gray-900 border-0 rounded-md shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-emerald-600 sm:text-sm sm:leading-6"
