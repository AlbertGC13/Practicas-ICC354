...
'Helvetica Neue', sans-serif;
  ...
  <title>Mockly PUCMM - Mocks</title>
</head>
            ...
            <div class="flex items-center px-2 lg:px-0">
              <div class="hidden sm:block">
                <div class="flex space-x-4">
                  ...
                  <a href="/admin/" class="px-3 py-2 text-sm font-medium text-black rounded-md ">Clientes</a>
                  <a href="/admin/mocks"
                    class="px-3 py-2 border border-white text-sm font-medium text-white rounded-md bg-black">Mocks</a>
                </div>
              </div>
            </div>
            ...
            <div class="sm:flex sm:items-center">
              <div class="sm:flex-auto">
                ...
                <p class="mt-2 text-sm text-gray-600 break-all	">
                  Tu TOKEN: <strong>${token}</strong>
                </p>
              </div>
              <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
                <a href="/admin/mock?localeData=es" type="button"
                  class="block px-3 py-2 text-sm font-semibold text-center text-white rounded-md shadow-sm bg-black hover:bg-black-500">
                  Nuevo Mock
                </a>
              </div>
            </div>
                      ...
                      <div class="flex gap-x-4">
                        <div class="flex-auto min-w-0">
                          <p class="text-sm font-semibold leading-6 text-gray-900">
                            <a href="http://${hostname}:${port}/mock/${mock.getRuta()}" target="_blank"
                          ...
                          <p class="flex mt-1 text-xs leading-5 text-white">
                            <span
                              class="relative truncate bg-emerald-600 rounded-lg">&nbsp;${mock.getCodigo()}&nbsp;</span>&nbsp;
                            <span
                              class="relative truncate bg-sky-600 rounded-lg">&nbsp;${mock.getContentType()}&nbsp;</span>&nbsp;
                            <span
                              class="relative truncate bg-indigo-700 rounded-lg">&nbsp;${mock.getFechaExpiracion()}&nbsp;</span>
                          </p>
                        </div>
                      </div>
                      <#if titulo=="Mis Mocks">
                        <div class="flex flex-col md:flex-row md:justify-center">
                          <a href="/admin/mock?id=${mock.getId()}&localeData=es" type="button"
                            class="relative truncate text-white bg-black hover:bg-black-800 focus:ring-4 focus:ring-teal-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2">
                            Editar
                          </a>
                          <a href="/admin/borrarMock/${mock.getId()}" type="button"
                            onclick="return confirm('Desea eliminar este mock?');"
                        ...
                        <#else>
                          <a href="/admin/mock?id=${mock.getId()}&localeData=es" type="button" <
                            class="relative truncate text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2">
                            Ver
                          </a>
                      </#if>
                    </li>
