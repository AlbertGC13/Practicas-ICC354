                    ...
                    <li class="relative flex justify-between px-4 py-5 gap-x-6 hover:bg-gray-50 sm:px-6 lg:px-8">
                      <div class="flex gap-x-4">
                        <div class="flex-auto min-w-0">
                          ...
                          <p class="flex mt-1 text-xs leading-5 text-white">
                            <span
                              class="relative truncate bg-sky-600 rounded-lg">&nbsp;${mock.getCodigo()}&nbsp;</span>&nbsp;
                            <span
                              class="relative truncate bg-emerald-600 rounded-lg">&nbsp;${mock.getContentType()}&nbsp;</span>&nbsp;
                            <span
                      ...
                      <div class="flex flex-col md:flex-row md:justify-center">
                        <a href="/user/mock?id=${mock.getId()}&localeData=es" type="button"
                          class="relative truncate text-white bg-black hover:bg-black-800 focus:ring-4 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2">
                          Editar
                        </a>
                        <a href="/user/borrarMock/${mock.getId()}" type="button"
